        ...
        <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-32">
            ...
            <div class="flex flex-col-reverse">
                ...
                <div class="flex items-center" id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                    ...
                    <img id="mainImage" src="{{ $product->main_image }}" alt="Angled front view with bag zipped and handles upright." class="size-96 lg:size-[500px] aspect-square object-cover sm:rounded-lg">
