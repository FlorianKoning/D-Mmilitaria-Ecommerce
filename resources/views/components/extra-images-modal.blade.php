              ...
              <div class="space-y-10">
                ...
                <div class="col-span-full">
                    <div class="sm:flex-auto">
                        ...
                        <p class="mt-2 text-sm text-gray-700">Hier upload u de extrafoto fotos die de gebruiker kan zien op de product pagina.</p>
                    </div>
                    <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                        <div class="text-center">
                            ...
                            <div class="mt-4 flex text-sm/6 text-gray-600">
                                <label for="extraImage" class="relative cursor-pointer rounded-md bg-white font-semibold text-logoBackground focus-within:outline-none focus-within:ring-2 focus-within:ring-logotext-logoBackground focus-within:ring-offset-2 hover:text-logoBackground">
                                    <span class="ml-7">Upload foto</span>
                                    <input id="extraImage" name="extraImage" type="file" class="sr-only">
                                </label>
                            </div>
                            <p class="text-xs/5 text-gray-600">PNG, JPG up to 10MB</p>
                        </div>
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('extraImage')" />
                </div>
