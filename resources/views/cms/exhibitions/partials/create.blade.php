<section>
    ...
    <form method="POST" action="{{ route('cms.exhibition.store') }}">
        @csrf
        ...
        <div class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="exhibition_name" name="exhibition_name" type="text" class="mt-1 block w-full" :value="old('exhibition_name')" required />
            ...
            <div>
                ...
                <x-text-input id="exhibition_location" name="exhibition_location" type="text" class="mt-1 block w-full" :value="old('exhibition_location')" required />
            ...
            <div>
                ...
                <x-text-input id="exhibition_date" name="exhibition_date" type="date" class="mt-1 block w-full" :value="old('exhibition_date')" required />
