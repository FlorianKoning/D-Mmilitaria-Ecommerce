        ...
        <nav class="flex flex-1 flex-col border-r">
            <ul role="list" class="flex flex-1 flex-col gap-y-3">
                ...
                <li class="px-6">
                    <ul id="management" role="list" class="-mx-2 space-y-1">
                        <div>
                            <x-cms-nav-link :href="route('cms.soldProducts.index')" :active="request()->routeIs('cms.soldProducts.*')">
                                <div class="flex flex-row gap-x-3 ml-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li class="px-6">
                    <ul id="overview" role="list" class="-mx-2 space-y-1">
                        <x-cms-nav-link :href="route('cms.newsletter.index')" :active="request()->routeIs('cms.newsletter.*')">
                            <div class="flex flex-row gap-x-3 ml-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li class="px-6">
                    <ul id="overview" role="list" class="-mx-2 space-y-1">
                        <x-cms-nav-link :href="route('cms.users.index')" :active="request()->routeIs('cms.users.*')">
                            <div class="flex flex-row gap-x-3 ml-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li class="px-6">
                 ...
                 <li class="px-6">
                    <ul id="overview" role="list" class="-mx-2 space-y-1">
                        <x-cms-nav-link :href="route('cms.businessSettings.index')" :active="request()->routeIs('cms.businessSettings.*')">
                            <div class="flex flex-row gap-x-3 ml-2">
