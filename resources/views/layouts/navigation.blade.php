                    ...
                    <div class="flex px-2 lg:px-0">
                        ...
                        <div class="sm:hidden flex shrink-0 items-center">
                            <a href="{{ route('home.index') }}">
                                <img class="size-10" src="{{ $business->business_logo }}" alt="">
                            </a>
                        </div>
            ...
            <div id="phoneNav" class="hidden flex justify-between" id="mobile-menu">
                <div class="ml-8 space-y-1 pt-2 pb-3">
                    ...
                    <x-responsive-nav-link :href="route('contact.index')" :active="request()->routeIs('contact.*')">
                     ...
                     <x-responsive-nav-link :href="route('exhibition.index')" :active="request()->routeIs('exhibition.*')">
                        {{ __('Fairs/Beurzen') }}
                    </x-responsive-nav-link>
