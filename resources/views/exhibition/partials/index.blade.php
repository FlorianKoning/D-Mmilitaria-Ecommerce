<div class="px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col">
        ...
        <p class="text-pretty text-sm tracking-tight text-gray-900 sm:text-base">
            ...
            <a class="border-navBackground text-navBackground font-semibold hover:border-b-2" href="{{ route('contact.index') }}">contact</a> pagina.<br>
            Of u zelf contact opnemen via ons email address: <span class="font-semibold">{{ $business->business_email }}</span>
        </p>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-300">
                <div class="h-16 w-full bg-navBackground sm:rounded-t-lg px-5">
                    <div class="flex flex-row gap-6">
                        <div class="flex flex-row gap-2">
                            ...
                            <button type="button" class="mt-4 inline-flex items-center gap-x-1.5 rounded-md bg-gray-400 px-3 text-sm font-semibold text-white shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 cursor-pointer">
                                Search
                            </button>
                ...
                <thead class="bg-navBackground h-9">
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-white">Beurs Aankomst Tijd</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-white">Beurs Vertrek Tijd</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                @foreach ($exhibitions as $exhibition)
                    <tr class="even:bg-gray-50">
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $exhibition->exhibition_start_time }}</td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $exhibition->exhibition_end_time }}</td>
