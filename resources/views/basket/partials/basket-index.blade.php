      ...
      <form class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
        <section aria-labelledby="cart-heading" class="lg:col-span-7">
          ...
          <ul role="list" class="divide-y divide-gray-200 border-b border-t border-gray-200">
            ...
            <li class="flex py-6 sm:py-10">
              <div class="shrink-0">
                <img src="https://www.therupturedduck.com/cdn/shop/files/RD_112624_0508_large.jpg?v=1734457619" alt="Front of men&#039;s Basic Tee in black." class="size-24 rounded-md object-cover sm:size-48">
              </div>
              ...
              <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                  ...
                  <div class="mt-4 sm:mt-0 sm:pr-9">
                    <div class="grid w-full max-w-16 grid-cols-1">
                      <select name="quantity-1" aria-label="Quantity, Basic Tee" class="col-start-1 row-start-1 appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
            ...
            <li class="flex py-6 sm:py-10">
              <div class="shrink-0">
                <img src="https://www.warrelics.eu/forum/attachments/field-equipment-accessories-third-reich/1591102d1655215057-critique-my-mannequin-feldwebel-field-display-dsc_7385.jpg" alt="Insulated bottle with white base and black snap lid." class="size-24 rounded-md object-cover sm:size-48">
              </div>
              ...
              <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                  ...
                  <div class="mt-4 sm:mt-0 sm:pr-9">
                    <div class="grid w-full max-w-16 grid-cols-1">
                      <select name="quantity-2" aria-label="Quantity, Nomad Tumbler" class="col-start-1 row-start-1 appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
