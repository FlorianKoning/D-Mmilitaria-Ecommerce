            ...
            <div class="mt-10 flex flex-col gap-10 w-max-w-xl text-base/7 text-gray-700 lg:max-w-none">
                ...
                <div class="flex flex-row justify-between">
                    <p class="w-full">
                        ...
                        <br>
                        &emsp;{{ env('APP_NAME') }} is a registered company specializing in the sale of original military collectibles.
                        <br>
                ...
                <div class="flex flex-row justify-between">
                    <p class="w-full">
                        ...
                        <br>
                        Would you like to exercise one of these rights? Please contact us at: <span class="font-semibold">{{ $business->business_email }}</span>.
                    </p>
                </div>
