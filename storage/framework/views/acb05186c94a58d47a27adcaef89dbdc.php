    ...
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 bg-white p-5 rounded-xl border shadow">
        ...
        <div class="flex flex-col-reverse">
                ...
                <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" role="tablist">
                    ...
                    <?php $__currentLoopData = $extraImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button id="tabs-1-tab-1" class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-navBackground focus:ring-offset-4" aria-controls="tabs-1-panel-1" role="tab" type="button">
                            <span class="sr-only">Angled view</span>
                            <span class="absolute inset-0 overflow-hidden rounded-md">
                                <img onclick="changeImage($(this).attr('src'))" src="<?php echo e($image->image_url); ?>" alt="<?php echo e($image->image_name); ?>" class="size-full object-cover">
                            </span>
            ...
            <div id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                <img id="mainImage" src="<?php echo e($product->main_image); ?>" alt="Angled front view with bag zipped and handles upright." class="aspect-square w-full object-cover sm:rounded-lg">
            </div>
...
<?php /**PATH D:\wamp\www\D-Mmilitaria-Ecommerce\resources\views/products/partials/products-show.blade.php ENDPATH**/ ?>