    ...
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 bg-white p-5 rounded-xl border shadow">
        ...
        <div class="flex flex-col-reverse">
            ...
            <div class="flex items-center" id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                ...
                <img id="mainImage" src="<?php echo e($product->main_image); ?>" alt="Angled front view with bag zipped and handles upright." class="size-[500px] aspect-square object-cover sm:rounded-lg">
...
<?php /**PATH C:\wamp64\www\dbmMilitaria\resources\views/products/partials/products-show.blade.php ENDPATH**/ ?>