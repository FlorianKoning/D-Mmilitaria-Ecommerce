...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.redirect-button','data' => ['route' => route('cms.catagories.create', true),'name' => __('Catagorie land toevoegen')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('cms.catagories.create', true)),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Catagorie land toevoegen'))]); ?>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    <thead>
                        <tr>
                            ...
                            <?php $__currentLoopData = $landColumnNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <?php $__currentLoopData = $landCatagories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900"><?php echo e($value->name); ?></td>
                                <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">
                                    <a href="<?php echo e(route('cms.catagories.edit', [$value->id, true])); ?>">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/cms/catagories/partials/catagories-index-land.blade.php ENDPATH**/ ?>