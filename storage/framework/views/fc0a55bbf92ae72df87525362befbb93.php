...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <form method="POST" action="<?php echo e(route('cms.products.extraCategorieStore', [$product->id, 'land'])); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div>
                        ...
                        <?php $__currentLoopData = $landCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/cms/products/partials/products-categories-land.blade.php ENDPATH**/ ?>