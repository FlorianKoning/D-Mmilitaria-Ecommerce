...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-around">
            <h2 class="font-semibold text-xl text-white leading-tight flex-1">
                <?php echo e(__('Gebruiker Toevoegen')); ?>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-10">
            <form method="post" action="<?php echo e(route('cms.users.store')); ?>" class="mt-6 space-y-10" enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
                
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <?php echo $__env->make('cms.users.partials.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/cms/users/create.blade.php ENDPATH**/ ?>