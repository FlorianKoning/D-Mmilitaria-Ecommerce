                        ...
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <a href="<?php echo e(route('cms.orders.index', ['option' => 'thisWeek'])); ?>">
                                    <p id="orderAmount" class="tetx-xs text-[#696A6C] hover:text-white hover:underline font-semibold transition duration-300 ease-in-out"><?php echo e($orders->ordersThisWeek); ?> Bestellingen</p>
                                </a>
                            </div>
                        </div>
...
</script><?php /**PATH C:\wamp64\www\dbmMilitaria\resources\views/components/cms/dashboard/dashboard-top-tiles.blade.php ENDPATH**/ ?>