<section>
    <div class="bg-white">
        <div class="mx-auto max-w-full px-6 lg:px-8">
          ...
          <div class="mx-auto wp lg:max-w-none">
            <div class="border-b border-t border-gray-200 bg-white shadow-sm rounded-lg sm:border">
                <div class="flex items-center border-b border-gray-200 p-4 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
                    <dl class="grid flex-1 grid-cols-2 gap-x-6 gap-y-5 text-sm sm:col-span-5 sm:grid-cols-5 lg:col-span-2">
                        <div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 font-medium text-gray-900">
                                <button type="button" class="rounded w-full <?php echo e($orderStatusColor[$orderStatusRepository->find($order->order_status_id)['status']]); ?> px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        ...
                        <div class="mt-auto">
                            <div class="col-span-2 flex space-x-4">
                                <a href="<?php echo e(route('download.invoice', $order->id)); ?>" class="flex items-center justify-center rounded-md border border-gray-300 bg-white px-2.5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-navBackground focus:ring-offset-2">
          ...
          <div class="mx-auto max-w-full">
            <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
              <dl class="grid max-w-full grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">

                <div class="flex w-full flex-col border border-gray-200 shadow rounded-lg p-4">
                  ...
                  <dd class="mt-2 flex flex-col text-base/7 text-gray-600">
                    <ul class="pl-6 list-disc">
                        <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">name: </span><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></li>
                        <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">Amount of items: </span><?php echo e($itemAmount); ?>
                ...
                <div class="flex w-full flex-col border border-gray-200 shadow rounded-lg p-4">
                    ...
                    <dd class="mt-2 flex flex-auto flex-col justify-between text-base/7 text-gray-600">
                        <ul class="pl-6 list-disc">
                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">name: </span><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></li>
                            <li class="flex-auto text-gray-500 text-xs"><span class="text-base text-gray-900 font-semibold">Email: </span><?php echo e($user->email); ?></li>
                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">PhoneNumber: </span><?php echo e($shipping->phone_number); ?></li>
                        </ul>

                        
                        <?php if(Auth::check()): ?>
                            <p class="mt-4">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="text-sm/6 font-semibold text-navBackground hover:text-navBackground/80 transition duration-300 ease-in-out">Customer profile settings <span aria-hidden="true">→</span></a>
                            </p>
                        <?php endif; ?>
                    </dd>
                </div>
                ...
                <div class="flex w-full flex-col border border-gray-200 shadow rounded-lg p-4">
                    ...
                    <dd class="mt-2 flex flex-auto flex-col text-base/7 text-gray-600">
                        <ul class="pl-6 list-disc">
                            <li class="flex-auto text-gray-500 mb-2"><span class="text-gray-900 font-semibold">Naam: </span><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></li>
                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">Address: </span><?php echo e($shipping->address); ?>

                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">PostCode: </span><?php echo e($shipping->postal_code); ?>

                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">Stad: </span><?php echo e($shipping->city); ?>

                        </ul>
                        <p class="mt-4">
                            <a href="<?php echo e(route('shipping.edit', $order->id)); ?>" class="text-sm/6 font-semibold text-navBackground hover:text-navBackground/80 transition duration-300 ease-in-out">Edit shipping Settings <span aria-hidden="true">→</span></a>
                        </p>
                    </dd>
                </div>
...
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/public/partials/confirmation.blade.php ENDPATH**/ ?>