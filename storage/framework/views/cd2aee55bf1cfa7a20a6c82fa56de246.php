<section>
    <div class="bg-white">
        <div class="mx-auto max-w-full px-6 lg:px-8">
          <div class="max-w-2xl">
            <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl lg:text-balance">Bedank voor uw bestelling!</p>
            <p class="mt-6 text-lg/8 text-gray-600">We hebben je order goed ontvangen en zijn direct aan de slag gegaan.</p>
            <p class="text-lg/8 text-gray-600">Binnenkort ontvang je een bevestigingsmail met alle details.</p>
          </div>
                ...
                <div class="flex flex-col border border-gray-200 shadow rounded-lg p-4 w-96">
                  ...
                  <dd class="mt-2 flex flex-col text-base/7 text-gray-600">
                    <ul class="pl-6 list-disc">
                        ...
                        <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">Aantal Items: </span><?php echo e($itemAmount); ?>
                ...
                <div class="flex flex-col border border-gray-200 shadow rounded-lg p-4 w-96">
                    ...
                    <dd class="mt-2 flex flex-auto flex-col justify-between text-base/7 text-gray-600">
                        <ul class="pl-6 list-disc">
                            ...
                            <li class="flex-auto text-gray-500"><span class="text-gray-900 font-semibold">Telefoon Nummer: </span><?php echo e($shipping->phone_number); ?>

                        </ul>
                        <p class="mt-4">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="text-sm/6 font-semibold text-navBackground hover:text-navBackground/80 transition duration-300 ease-in-out">Klant profiel settings <span aria-hidden="true">→</span></a>
                        </p>
                    </dd>
                </div>
