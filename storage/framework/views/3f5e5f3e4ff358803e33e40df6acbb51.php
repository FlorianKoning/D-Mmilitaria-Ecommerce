                ...
                <td style="border-radius: 8px; background-color: #fffffe; border: 1px solid #e2e8f0">
                    ...
                    <div class="sm-p-6" style="padding: 24px 36px">
                      ...
                      <h1 style="margin: 0 0 24px; font-size: 24px; line-height: 32px; font-weight: 600; color: #0f172a">
                          Your order number is: <?php echo e($orderNumber); ?><br>
                      </h1>
                      <p style="margin: 0 0 24px; font-size: 14px; color: #475569">
                          Dear <?php echo e($customerName); ?>,
                          <br><br>
                          Your order on <?php echo e(env('APP_NAME')); ?> has been cancelled because the payment was not successfully completed.
                          <br><br>
                          ...
                          <br><br>
                          If you have any questions or want to try placing the order again, please feel free to contact us at <span style="font-weight: 600"><?php echo e($businessSettings->business_email); ?></span>.
                          <br>
                      </p>
...
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/mail/emails/canceled.blade.php ENDPATH**/ ?>