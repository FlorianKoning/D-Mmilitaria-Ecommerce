                ...
                <td style="border-radius: 8px; background-color: #fffffe; border: 1px solid #e2e8f0">
                    ...
                    <div class="sm-p-6" style="padding: 24px 36px">
                        ...
                        <h1 style="margin: 0 0 24px; font-size: 24px; line-height: 32px; font-weight: 600; color: #0f172a">
                            Uw bestel nummer is: <?php echo e($orderNumber); ?><br>
                        </h1>
                        <p style="margin: 0 0 24px; font-size: 14px; color: #475569">
                            ...
                            <br><br>
                            Heb je vragen of wil je de bestelling opnieuw proberen? Neem gerust contact met ons op via <span style="font-weight: 600"><?php echo e($businessSettings->business_email); ?></span>.
                            <br>
                        </p>
