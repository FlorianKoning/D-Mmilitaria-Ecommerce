<div class="relative isolate px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">D&Mmilitaria</h2>
      
    </div>
</div>
</div>
<?php /**PATH D:\wamp\www\D-Mmilitaria-Ecommerce\resources\views/components/banner.blade.php ENDPATH**/ ?>