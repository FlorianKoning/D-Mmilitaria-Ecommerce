            ...
            <div class="mt-10 flex flex-col gap-10 w-max-w-xl text-base/7 text-gray-700 lg:max-w-none">
                ...
                <div class="flex flex-row justify-between">
                    <p class="w-full">
                        ...
                        <br>
                        &emsp;KvK-nummer: <span class="font-semibold"><?php echo e($business->kvk_number); ?></span>
                        <br>
                        &emsp;BTW-nummer: <span class="font-semibold"><?php echo e($business->btw_number); ?></span>
                        <br>
                        &emsp;Vestigingsadres: <span class="font-semibold"><?php echo e($business->business_address); ?></span>
                    </p>
                </div>
...
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/public/partials/privacy.blade.php ENDPATH**/ ?>