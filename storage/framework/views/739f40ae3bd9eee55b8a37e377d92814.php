                ...
                <td style="border-radius: 8px; background-color: #fffffe; border: 1px solid #e2e8f0">
                  ...
                  <div style="display: flex; height: 80px; width: 100%; flex-direction: row; gap: 16px; border-top-left-radius: 8px; border-top-right-radius: 8px; background-image: url(https://i.pinimg.com/originals/db/21/43/db2143142ab64643671cba3322f43bfd.jpg)">
                    <a href="<?php echo e(route('home.index')); ?>">
                      <img src="<?php echo e($businessSettings->business_logo); ?>" alt style="max-width: 100%; vertical-align: middle; width: 64px; height: 64px; border-width: 2px; border-color: #111827; padding: 8px" width="64" height="64">
                    </a>
                  ...
                  <div class="sm-p-6" style="padding: 24px 36px">
                    ...
                    <h1 style="margin: 0 0 24px; font-size: 20px; line-height: 32px; font-weight: 600; color: #0f172a">
                      Bank Transfer | Order Number | <?php echo e($orderNumber); ?>
