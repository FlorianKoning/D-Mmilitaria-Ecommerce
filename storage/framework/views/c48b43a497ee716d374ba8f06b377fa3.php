...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['sessionText']));
...
foreach (array_filter((['sessionText']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/components/session-warning.blade.php ENDPATH**/ ?>