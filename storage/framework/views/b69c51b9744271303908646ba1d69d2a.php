            ...
            <div class="w-2/3 flex flex-col-reverse">
                ...
                <div class="mx-auto mt-6 hidden w-full max-w-2xl sm:block lg:max-w-none">
                    <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" role="tablist">
                        ...
                        <?php $__currentLoopData = $extraImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button id="tabs-1-tab-1" class="relative flex h-40 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-navBackground focus:ring-offset-4" aria-controls="tabs-1-panel-1" role="tab" type="button">
                                <span class="absolute inset-0 overflow-hidden rounded-md">
                                    <img onclick="changeImage($(this).attr('src'), '<?php echo e($image->order); ?>')" src="<?php echo e($image->image_url); ?>" alt="<?php echo e($image->image_name); ?>" class="w-full h-full object-contain">
                                </span>
                ...
                <div>
                    ...
                    <div class="flex items-center select-none" id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                        <div onclick="imageArray('left', '<?php echo e($product->id); ?>')" class="hover:text-navBackground hover:cursor-pointer p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                            </svg>
                        </div>
    
                        <img onclick="toogleZoom()" id="mainImage" src="<?php echo e($product->main_image); ?>" alt="<?php echo e($product->description); ?>" class="w-3/4  object-cover sm:rounded-lg hover:cursor-pointer">
    
                        <div onclick="imageArray('right', '<?php echo e($product->id); ?>')" class="hover:text-navBackground hover:cursor-pointer p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16">
