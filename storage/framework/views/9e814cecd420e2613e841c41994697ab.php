...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto h-svh border-t-2 border-black/80 flex flex-col content-start">
        <div class="py-12">
            <?php echo $__env->make('cart.partials.cart-index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\D-Mmilitaria-Ecommerce\resources\views/cart/cart-index.blade.php ENDPATH**/ ?>